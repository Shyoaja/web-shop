...
const faqData = [
    {
        question: 'Apa itu ShyoID?',
        answer: '<ul>ShyoID adalah penyedia layanan hosting terkemuka yang berfokus pada panel Pterodactyl untuk server game dan aplikasi. Kami menawarkan hosting berkualitas premium dengan harga terjangkau dan performa optimal.</ul>'
    },
    {
        question: 'Bagaimana cara membeli hosting di Shyot?',
        answer: '<ul>Untuk membeli hosting, Anda perlu mengisi "Informasi Akun" Anda, memilih "Paket Hosting" yang diinginkan, memilih "Metode Pembayaran" (QRIS, Gopay, atau DANA), lalu memeriksa "Ringkasan Pesanan". Setelah itu, klik tombol "BELI" untuk melanjutkan konfirmasi pembayaran dan aktivasi layanan melalui WhatsApp Admin Shyot.</ul>'
    },
    {
    ...
    {
        question: 'Apakah Shyo menyediakan layanan support?',
